...
export const Chart = ({ used = 0 }: { used: number }) => {
  ...
  return (
    <Card className="chart-card flex items-center rounded-[20px] bg-[#FA7275] p-5 text-white shadow-lg md:flex-col xl:flex-row">
      <CardContent className="flex-1 p-0">
        <ChartContainer config={chartConfig} className="mx-auto aspect-square w-45 text-white xl:w-62.5">
          <RadialBarChart
            data={chartData}
            startAngle={90}
      ...
      <CardHeader className="flex-1 items-start px-3 py-0 sm:px-5 lg:p-3 xl:pr-5">
        ...
        <CardDescription className="text-[16px] leading-6 font-medium mt-2 w-full text-white/70 md:text-center lg:text-left">
