...
const MobileNavigation = ({
    ...
    return (
        <header className="flex h-15 justify-between px-5 sm:hidden">
            <Image
            ...
            <Sheet open={open} onOpenChange={setOpen}>
                ...
                <SheetContent className="pt-0 h-screen px-3">
                        ...
                        <ul className="flex flex-1 flex-col gap-4">
                            {navItems.map(({ url, name, icon }) => (
                                <Link key={name} href={url} className="lg:w-full">
                                    <li
                                        className={cn(
                                            "flex text-light-100 gap-4 w-full justify-start items-center h5 px-6 h-13 rounded-full",
                    ...
                    <div className="flex flex-col justify-between gap-5 pb-5">
                        ...
                        <Button
                            type="submit"
                            className="h5 flex h-13 w-full items-center gap-4 rounded-full bg-[#FA7275]/10 px-6 text-[#FA7275] shadow-none transition-all hover:bg-[#FA7275]/20"
